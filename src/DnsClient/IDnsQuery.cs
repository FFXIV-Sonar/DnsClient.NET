...
namespace DnsClient
{
    ...
    public interface IDnsQuery
    {
        ...
        /// <exception cref="ArgumentNullException">If <paramref name="query"/> is null.</exception>
        /// <exception cref="DnsResponseException">After retries and fallbacks, if none of the servers were accessible, timed out or (if <see cref="DnsQueryOptions.ThrowDnsErrors"/> is enabled) returned error results.</exception>
        IDnsQueryResponse QueryServer(IEnumerable<NameServer> servers, string query, QueryType queryType, QueryClass queryClass = QueryClass.IN);
        ...
        /// <exception cref="DnsResponseException">After retries and fallbacks, if none of the servers were accessible, timed out or (if <see cref="DnsQueryOptions.ThrowDnsErrors"/> is enabled) returned error results.</exception>
        IDnsQueryResponse QueryServer(IEnumerable<NameServer> servers, DnsQuestion question);
        ...
        /// <exception cref="DnsResponseException">After retries and fallbacks, if none of the servers were accessible, timed out or (if <see cref="DnsQueryOptions.ThrowDnsErrors"/> is enabled) returned error results.</exception>
        IDnsQueryResponse QueryServer(IEnumerable<NameServer> servers, DnsQuestion question, DnsQueryOptions queryOptions);
        ...
        /// <exception cref="ArgumentNullException">If <paramref name="query"/> is null.</exception>
        /// <exception cref="DnsResponseException">After retries and fallbacks, if none of the servers were accessible, timed out or (if <see cref="DnsQueryOptions.ThrowDnsErrors"/> is enabled) returned error results.</exception>
        IDnsQueryResponse QueryServer(IEnumerable<IPEndPoint> servers, string query, QueryType queryType, QueryClass queryClass = QueryClass.IN);
        ...
        /// <exception cref="ArgumentNullException">If <paramref name="query"/> is null.</exception>
        /// <exception cref="DnsResponseException">After retries and fallbacks, if none of the servers were accessible, timed out or (if <see cref="DnsQueryOptions.ThrowDnsErrors"/> is enabled) returned error results.</exception>
        IDnsQueryResponse QueryServer(IEnumerable<IPAddress> servers, string query, QueryType queryType, QueryClass queryClass = QueryClass.IN);
        ...
        /// <exception cref="OperationCanceledException">If cancellation has been requested for the passed in <paramref name="cancellationToken"/>.</exception>
        /// <exception cref="DnsResponseException">After retries and fallbacks, if none of the servers were accessible, timed out or (if <see cref="DnsQueryOptions.ThrowDnsErrors"/> is enabled) returned error results.</exception>
        Task<IDnsQueryResponse> QueryServerAsync(IEnumerable<NameServer> servers, string query, QueryType queryType, QueryClass queryClass = QueryClass.IN, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ArgumentNullException">If <paramref name="servers"/> or <paramref name="question"/> is null.</exception>
        /// <exception cref="DnsResponseException">After retries and fallbacks, if none of the servers were accessible, timed out or (if <see cref="DnsQueryOptions.ThrowDnsErrors"/> is enabled) returned error results.</exception>
        Task<IDnsQueryResponse> QueryServerAsync(IEnumerable<NameServer> servers, DnsQuestion question, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ArgumentNullException">If <paramref name="servers"/>, <paramref name="question"/> or <paramref name="queryOptions"/> is null.</exception>
        /// <exception cref="DnsResponseException">After retries and fallbacks, if none of the servers were accessible, timed out or (if <see cref="DnsQueryOptions.ThrowDnsErrors"/> is enabled) returned error results.</exception>
        Task<IDnsQueryResponse> QueryServerAsync(IEnumerable<NameServer> servers, DnsQuestion question, DnsQueryOptions queryOptions, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="OperationCanceledException">If cancellation has been requested for the passed in <paramref name="cancellationToken"/>.</exception>
        /// <exception cref="DnsResponseException">After retries and fallbacks, if none of the servers were accessible, timed out or (if <see cref="DnsQueryOptions.ThrowDnsErrors"/> is enabled) returned error results.</exception>
        Task<IDnsQueryResponse> QueryServerAsync(IEnumerable<IPAddress> servers, string query, QueryType queryType, QueryClass queryClass = QueryClass.IN, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="OperationCanceledException">If cancellation has been requested for the passed in <paramref name="cancellationToken"/>.</exception>
        /// <exception cref="DnsResponseException">After retries and fallbacks, if none of the servers were accessible, timed out or (if <see cref="DnsQueryOptions.ThrowDnsErrors"/> is enabled) returned error results.</exception>
        Task<IDnsQueryResponse> QueryServerAsync(IEnumerable<IPEndPoint> servers, string query, QueryType queryType, QueryClass queryClass = QueryClass.IN, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="DnsResponseException">After retries and fallbacks, if none of the servers were accessible, timed out or (if <see cref="DnsQueryOptions.ThrowDnsErrors"/> is enabled) returned error results.</exception>
        IDnsQueryResponse QueryServerReverse(IEnumerable<IPAddress> servers, IPAddress ipAddress);
        ...
        /// <exception cref="ArgumentNullException">If <paramref name="servers"/> or <paramref name="ipAddress"/> is null.</exception>
        /// <exception cref="DnsResponseException">After retries and fallbacks, if none of the servers were accessible, timed out or (if <see cref="DnsQueryOptions.ThrowDnsErrors"/> is enabled) returned error results.</exception>
        IDnsQueryResponse QueryServerReverse(IEnumerable<IPEndPoint> servers, IPAddress ipAddress);
        ...
        /// <exception cref="ArgumentNullException">If <paramref name="servers"/> or <paramref name="ipAddress"/> is null.</exception>
        /// <exception cref="DnsResponseException">After retries and fallbacks, if none of the servers were accessible, timed out or (if <see cref="DnsQueryOptions.ThrowDnsErrors"/> is enabled) returned error results.</exception>
        IDnsQueryResponse QueryServerReverse(IEnumerable<NameServer> servers, IPAddress ipAddress);
        ...
        /// <exception cref="DnsResponseException">After retries and fallbacks, if none of the servers were accessible, timed out or (if <see cref="DnsQueryOptions.ThrowDnsErrors"/> is enabled) returned error results.</exception>
        IDnsQueryResponse QueryServerReverse(IEnumerable<NameServer> servers, IPAddress ipAddress, DnsQueryOptions queryOptions);
        ...
        /// <exception cref="OperationCanceledException">If cancellation has been requested for the passed in <paramref name="cancellationToken"/>.</exception>
        /// <exception cref="DnsResponseException">After retries and fallbacks, if none of the servers were accessible, timed out or (if <see cref="DnsQueryOptions.ThrowDnsErrors"/> is enabled) returned error results.</exception>
        Task<IDnsQueryResponse> QueryServerReverseAsync(IEnumerable<IPAddress> servers, IPAddress ipAddress, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="OperationCanceledException">If cancellation has been requested for the passed in <paramref name="cancellationToken"/>.</exception>
        /// <exception cref="DnsResponseException">After retries and fallbacks, if none of the servers were accessible, timed out or (if <see cref="DnsQueryOptions.ThrowDnsErrors"/> is enabled) returned error results.</exception>
        Task<IDnsQueryResponse> QueryServerReverseAsync(IEnumerable<IPEndPoint> servers, IPAddress ipAddress, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="OperationCanceledException">If cancellation has been requested for the passed in <paramref name="cancellationToken"/>.</exception>
        /// <exception cref="DnsResponseException">After retries and fallbacks, if none of the servers were accessible, timed out or (if <see cref="DnsQueryOptions.ThrowDnsErrors"/> is enabled) returned error results.</exception>
        Task<IDnsQueryResponse> QueryServerReverseAsync(IEnumerable<NameServer> servers, IPAddress ipAddress, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="OperationCanceledException">If cancellation has been requested for the passed in <paramref name="cancellationToken"/>.</exception>
        /// <exception cref="DnsResponseException">After retries and fallbacks, if none of the servers were accessible, timed out or (if <see cref="DnsQueryOptions.ThrowDnsErrors"/> is enabled) returned error results.</exception>
        Task<IDnsQueryResponse> QueryServerReverseAsync(IEnumerable<NameServer> servers, IPAddress ipAddress, DnsQueryOptions queryOptions, CancellationToken cancellationToken = default);
    }
}
